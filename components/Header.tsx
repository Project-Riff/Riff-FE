      ...
      <div className="mx-auto flex h-[76px] max-w-[1240px] items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2.5">
          <a
            ...
            className="flex h-[40px] w-[40px] items-center justify-center rounded-full bg-[#ff7a2f] text-white shadow-[0_4px_12px_rgba(255,122,47,0.25)] transition-all duration-300 hover:bg-[#ff8a3d] hover:scale-105 active:scale-95"
            title="인스타그램 방문하기"
          >
