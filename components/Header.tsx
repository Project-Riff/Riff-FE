      ...
      <div className="mx-auto flex h-[58px] max-w-[1240px] items-center justify-between px-6 md:h-[76px]">
        ...
        <div className="flex items-center gap-2.5">
          <a
            ...
            className="flex h-[34px] w-[34px] items-center justify-center rounded-full border border-black/8 bg-white text-[#111] transition-all duration-300 hover:bg-[#fafafa] hover:scale-105 active:scale-95"
            title="인스타그램 방문하기"
          >
          ...
          <Link
            href="/apply"
            className="inline-flex h-[40px] items-center gap-2 rounded-full bg-[#ff7a2f] px-4 text-[13px] font-medium text-white shadow-[0_4px_12px_rgba(255,122,47,0.2)] transition duration-300 hover:bg-[#ff8a3d]"
          >
            제작 문의
