...
const stageProgressUnit = 100 / pipelineStages.length;
...
function resolvePipelineStep(stage?: string, message?: string) {
  ...
  if (stage === "uploading" || stage === "uploaded" || stage === "downloading")
    return 1;
  if (stage === "compressing") return 1;
  ...
  if (stage === "rendering") {
    if (normalizedMessage.includes("음성 및 자막")) return 6;
    return 7;
  }
...
export default function AdminDesignPreviewPage() {
  ...
  const pipelinePercent =
    !job?.stage || job.stage === "queued"
      ...
      : job?.stage === "done"
        ? 100
        : Number((currentStep * stageProgressUnit).toFixed(1));
  const sweepStep =
    ...
    <main className="min-h-screen bg-white px-5 py-6 text-slate-900 md:px-8">
      <div className="mx-auto max-w-[1540px]">
        <div className="relative">
          ...
          <div className="grid min-h-[calc(100vh-140px)] grid-cols-1 gap-10 xl:grid-cols-[minmax(0,1fr)_280px]">
            ...
            <aside className="px-3 py-6 xl:pt-[78px]">
              <div className="space-y-8">
                <div className="border-l border-[#f1e8df] pl-5">
                  ...
                  <div className="mt-3 flex items-center gap-3">
                    ...
                    <StageBadge
                      status={pipelineStatuses[currentStep - 1] ?? "idle"}
                    />
                  </div>
                ...
                <div className="space-y-4 border-l border-[#f6eee7] pl-5">
